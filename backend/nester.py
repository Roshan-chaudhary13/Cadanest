...
def unfold_part_to_temp_dxf(step_path, kfactor, base_face_name=None, minimal_dimple_holes=True, bend_radius=None, etch_marker_position="interior", etch_marker_length=4.5):
...
def run_nesting_from_dict(config: dict) -> dict:
    ...
    global_etch_len = float(config.get("etch_marker_length") or config.get("etchMarkerLength") or 4.5)
